...
class OdysseyControllerCity extends JControllerForm
{
  ...
  public function save($key = null, $urlVar = null)
  {
	...
	if(OdysseyHelper::isInStep($data['id'], 'city')) {
	  $app = JFactory::getApplication();
	  // Save the data in the session.
	  $app->setUserState($this->option.'.edit.'.$this->context.'.data', $data);
	  $app->enqueueMessage(JText::_('COM_ODYSSEY_WARNING_CITY_USED_IN_STEP'), 'warning');
