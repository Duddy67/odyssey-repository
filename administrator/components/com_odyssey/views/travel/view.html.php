...
class OdysseyViewTravel extends JViewLegacy
{
  ...
  protected function addToolBar() 
  {
    ...
    JToolBarHelper::title($isNew ? JText::_('COM_ODYSSEY_NEW_TRAVEL') : JText::_('COM_ODYSSEY_EDIT_TRAVEL'), 'pencil-2');

    if($isNew) {
      //Check the "create" permission for the new records.
      if($canDo->get('core.create')) {
	JToolBarHelper::apply('travel.apply', 'JTOOLBAR_APPLY');
	JToolBarHelper::save('travel.save', 'JTOOLBAR_SAVE');
	JToolBarHelper::custom('travel.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
      }
    }
    else {
	...
	if($canDo->get('core.edit') || ($canDo->get('core.edit.own') && $this->item->created_by == $userId)) {
      ...
      if($canDo->get('core.create')) {
	//JToolBarHelper::save2copy('travel.save2copy');
      }
    }

    JToolBarHelper::cancel('travel.cancel', 'JTOOLBAR_CANCEL');
  }
