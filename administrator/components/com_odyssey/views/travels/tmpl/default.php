...
<form action="<?php echo JRoute::_('index.php?option=com_odyssey&view=travels');?>" method="post" name="adminForm" id="adminForm">
...
?>
  ...
  <?php else : ?>
    <table class="table table-striped" id="travelList">
      <thead>
	<tr>
	...
	<th>
	<?php echo JHtml::_('searchtools.sort', 'COM_ODYSSEY_FIELD_NAME_LABEL', 't.name', $listDirn, $listOrder); ?>
	</th>
	<th width="10%" class="nowrap hidden-phone">
	  <?php echo JHtml::_('searchtools.sort',  'JGRID_HEADING_ACCESS', 't.access', $listDirn, $listOrder); ?>
	</th>
	<th width="10%" class="nowrap hidden-phone">
	...
	<th width="1%" class="nowrap hidden-phone">
	  <?php echo JHtml::_('searchtools.sort', 'JGLOBAL_HITS', 't.hits', $listDirn, $listOrder); ?>
	</th>
	<th width="1%" class="nowrap hidden-phone">
	<?php echo JHtml::_('searchtools.sort', 'JGRID_HEADING_ID', 't.id', $listDirn, $listOrder); ?>
      ...
      $canEdit = $user->authorise('core.edit','com_odyssey.travel.'.$item->id);
	...
	<td class="order nowrap center hidden-phone">
	  ...
	  <td class="center">
	    <div class="btn-group">
	      <?php echo JHtml::_('jgrid.published', $item->published, $i, 'travels.', $canChange, 'cb'); ?>
	      <?php
	      // Create dropdown items
	      $action = $archived ? 'unarchive' : 'archive';
	      JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'travels');
	  ...
	  <td class="has-context">
	    <div class="pull-left">
		  ...
		  <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'travels.', $canCheckin); ?>
	      <?php endif; ?>
	      <?php if($canEdit || $canEditOwn) : ?>
		<a href="<?php echo JRoute::_('index.php?option=com_odyssey&task=travel.edit&id='.$item->id);?>" title="<?php echo JText::_('JACTION_EDIT'); ?>"><?php echo $this->escape($item->name); ?></a>
	      <?php else : ?>
