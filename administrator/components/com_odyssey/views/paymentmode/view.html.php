...
class OdysseyViewPaymentmode extends JViewLegacy
{
  protected $item;
  protected $form;
  protected $state;
  ...
  protected function addToolBar() 
  {
    ...
    JToolBarHelper::title($isNew ? JText::_('COM_ODYSSEY_NEW_PAYMENT_MODE') : JText::_('COM_ODYSSEY_EDIT_PAYMENT_MODE'), 'pencil-2');
