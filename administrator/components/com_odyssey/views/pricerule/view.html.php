...
class OdysseyViewPricerule extends JViewLegacy
{
  protected $item;
  protected $form;
  protected $state;
  ...
  protected function addToolBar() 
  {
    ...
    JToolBarHelper::title($isNew ? JText::_('COM_ODYSSEY_NEW_PRICERULE') : JText::_('COM_ODYSSEY_EDIT_PRICERULE'), 'pencil-2');
