...
<form action="<?php echo JRoute::_('index.php?option=com_odyssey&view=countries');?>" method="post" name="adminForm" id="adminForm">
...
?>
  ...
  <?php else : ?>
	...
	<?php echo JHtml::_('searchtools.sort', 'COM_ODYSSEY_HEADING_ALPHA_3', 'c.alpha_3', $listDirn, $listOrder); ?>
	</th>
	<th width="5%">
	...
	<?php echo JHtml::_('searchtools.sort', 'JGRID_HEADING_ID', 'c.id', $listDirn, $listOrder); ?>
      ...
      $canEdit = $user->authorise('core.edit','com_odyssey.country.'.$item->id);
      $canEditOwn = $user->authorise('core.edit.own', 'com_odyssey.country.'.$item->id) && $item->created_by == $userId;
      $canCheckin = $user->authorise('core.manage','com_checkin') || $item->checked_out == $userId || $item->checked_out == 0;
      $canChange = ($user->authorise('core.edit.state','com_odyssey.country.'.$item->id) && $canCheckin) || $canEditOwn; 
      ?>
	  ...
	  <td class="has-context">
		...
		<a href="<?php echo JRoute::_('index.php?option=com_odyssey&task=country.edit&id='.$item->id);?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
