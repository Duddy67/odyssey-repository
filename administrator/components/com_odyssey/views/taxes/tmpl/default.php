...
<form action="<?php echo JRoute::_('index.php?option=com_odyssey&view=taxes');?>" method="post" name="adminForm" id="adminForm">
...
?>
  ...
  <?php else : ?>
	...
	<th width="10%">
	<?php echo JHtml::_('searchtools.sort', 'COM_ODYSSEY_HEADING_RATE', 't.rate', $listDirn, $listOrder); ?>
	</th>
	...
	<?php echo JHtml::_('searchtools.sort', 'JGRID_HEADING_ID', 't.id', $listDirn, $listOrder); ?>
      ...
      $canEdit = $user->authorise('core.edit','com_odyssey.tax.'.$item->id);
      $canEditOwn = $user->authorise('core.edit.own', 'com_odyssey.tax.'.$item->id) && $item->created_by == $userId;
      $canCheckin = $user->authorise('core.manage','com_checkin') || $item->checked_out == $userId || $item->checked_out == 0;
      $canChange = ($user->authorise('core.edit.state','com_odyssey.tax.'.$item->id) && $canCheckin) || $canEditOwn; 
      ?>
	...
	<td class="order nowrap center hidden-phone">
	  ...
	  <td class="has-context">
		...
		<a href="<?php echo JRoute::_('index.php?option=com_odyssey&task=tax.edit&id='.$item->id);?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
