...
<form action="<?php echo JRoute::_('index.php?option=com_odyssey&view=pricerules&layout=modal&tmpl=component'.$modalOption.'&function='.$function);?>" method="post" name="adminForm" id="adminForm">
  ...
  <?php else : ?>
	...
	<tr>
	  <th class="title">
	    <?php echo JHtml::_('grid.sort', 'COM_ODYSSEY_HEADING_NAME', 'p.name', $listDirn, $listOrder); ?>
	  </th>
	  <th width="10%">
	    <?php echo JHtml::_('grid.sort', 'COM_ODYSSEY_HEADING_TYPE', 'p.prule_type', $listDirn, $listOrder); ?>
	  </th>
	  <th width="10%">
	    <?php echo JHtml::_('grid.sort', 'COM_ODYSSEY_HEADING_OPERATION', 'p.operation', $listDirn, $listOrder); ?>
	  </th>
	  <th width="15%">
	    <?php echo JHtml::_('grid.sort', 'COM_ODYSSEY_HEADING_TARGET', 'p.target', $listDirn, $listOrder); ?>
	  </th>
	  <th width="10%">
