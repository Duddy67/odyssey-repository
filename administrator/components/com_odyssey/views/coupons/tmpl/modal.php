...
<form action="<?php echo JRoute::_('index.php?option=com_jooshop&view=taxes&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm">
