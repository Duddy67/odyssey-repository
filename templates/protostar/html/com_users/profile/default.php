...
//We don't want the user to ends up on the standard Joomla user page. 
//So we redirect to the Odyssey customer page.
//$app = JFactory::getApplication();
//$app->redirect('index.php?option=com_odyssey&view=customer');
?>
