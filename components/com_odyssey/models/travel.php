...
class OdysseyModelTravel extends JModelItem
{
  ...
  public function getSelectedTravel()
  {
    ...
    $query->select('t.id AS travel_id, t.catid, t.dpt_step_id, t.name, t.alias, t.intro_text, ds.dpt_id, tp.price AS travel_price,'.
	           'IFNULL(tcp.price, 0) AS transit_price, ds.date_time, ds.date_time_2, ds.max_passengers,'.
		   's.date_type, tp.psgr_nb AS nb_psgr, stc.time_offset, tx.rate AS tax_rate, c.name AS dpt_city_name')
